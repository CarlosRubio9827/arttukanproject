    ...
    <div class="row">
        <div class="col-md-8 col-lg-8 col-xs-12 col-sm-8">
                ...
                @endif
                    ...
                    <a href="{{ route('ingresos.create') }}" ><button type="button" class="btn btn-success">Nuevo</button></a>
        </div>
    </div>
                    ...
                    <thead>
                        ...
                        @foreach ($ingresos as $ingreso)
                           ...
                           <tr> 
                               ...
                               <a href="{{ route('ingresos.show', $ingreso->idIngreso)  }}"><button class="btn btn-primary">Detalles</button></a>

                               <a href="" data-target="#modal-delete-{{ $ingreso->idIngreso }}" data-toggle="modal"><button class="btn btn-danger">Anular Ingreso</button></a>                              
