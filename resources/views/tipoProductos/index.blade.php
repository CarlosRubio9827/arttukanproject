                    ...
                    <thead>
                        ...
                        @foreach ($tipoProductos as $tipoProducto)
                           <tr> 
                                ...
                                <td>{{ $tipoProducto->condicion }}</td>
                                <td> 
                               

                               <a href="{{ route('tipoProductos.show', $tipoProducto->idTipoProducto)  }}"><button class="btn btn-primary">Ver</button></a>

                               <a href="{{ route('tipoProductos.edit', $tipoProducto->idTipoProducto)  }}"><button class="btn btn-primary">Editar</button></a>

                               <a href="" data-target="#modal-delete-{{ $tipoProducto->idTipoProducto }}" data-toggle="modal"><button class="btn btn-danger">Eliminar</button></a>                              
                                   
                                </td>
                               
                           </tr>
                           @include('tipoProductos.modal')
                        @endforeach
                </table>
            </div>
